...
class Sincro_Mailchimp_Log_Service {
	 ...
	 * @since  1.0.0
	 * @access private
	 * @var \Sincro_Mailchimp_Log_Service $instance A singleton instance for legacy logging.
	 */
	 ...
	 * @since 1.0.0
	 *
	 * @return \Sincro_Mailchimp_Log_Service A singleton instance for legacy logging.
	 */
	public static function get_instance() {
		return self::$instance ?: self::$instance = new Sincro_Mailchimp_Log_Service( 'ROOT' );
	}
